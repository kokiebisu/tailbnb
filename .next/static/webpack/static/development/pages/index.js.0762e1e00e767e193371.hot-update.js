...
var Home = function Home() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_Header__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    "class": "xl:max-x-layout lg:max-w-5.5xl mx-auto mt-110 mb-32 bg-blue-500",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
    ...
    className: "text-xl font-medium pb-1 pt-2 ",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    },
    ...
    __self: this
  }, "A selection of places to stay verified for quality and design."), __jsx("img", {
    className: "w-full bg-cover bg-no-repeat bg-top-right",
    src: "",
    alt: "plus1",
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.0762e1e00e767e193371.hot-update.js.map