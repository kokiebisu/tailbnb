...
var Home = function Home() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_Header__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    className: "text-xl font-semibold py-3 mt-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    },
    ...
    className: "flex flex-wrap items-center justify-start lg:w-1/3 bg-white rounded-xl",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "flex flex-wrap items-center justify-start w-1/3 bg-white rounded-xl shadow-xl",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22
    },
...
//# sourceMappingURL=index.js.064c14ee08ea5b5d3cb1.hot-update.js.map