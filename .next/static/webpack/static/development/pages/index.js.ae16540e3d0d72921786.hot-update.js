...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    className: "lg:px-20 px-4 xl:px-0 xl:max-w-5.5xl mx-auto pt-10 pb-10 bg-blue-500",
    __source: {
    ...
    className: "hidden md:flex md:flex-wrap md:items-start md:w-full md:justify-between md:pb-6 md:border-b md:border-gray-300 bg-red-500",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 5
    },
...
//# sourceMappingURL=index.js.ae16540e3d0d72921786.hot-update.js.map