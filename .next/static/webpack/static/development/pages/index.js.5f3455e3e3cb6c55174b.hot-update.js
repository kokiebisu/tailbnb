...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  function renderPhrase() {
    if (phrase) {
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("h3", {
        className: "bg-blue-500 scrollable text-gray-850 text-2xl font-semibold py-3 ",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 15
        },
  ...
  return __jsx("div", {
    className: "bg-red-500 sm:px-5 md:px-10 xl:px-0 lg:max-w-5.5xl mx-auto py-5 overflow-x-hidden overflow-y-hidden w-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 23
    },
...
//# sourceMappingURL=index.js.5f3455e3e3cb6c55174b.hot-update.js.map