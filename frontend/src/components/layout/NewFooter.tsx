  ...
  return (
    <div className='block bg-white w-full border-t border-gray-300'>
      <div className='px-6 md:px-0 md:mx-20 xl:mx-20 xl:max-w-10.5xl mx-auto py-6 sm:py-12'>
        ...
        <div className='md:mt-8 w-full flex flex-col-reverse lg:flex-row md:justify-center lg:justify-between lg:mt-10'>
          <div className='md:flex md:flex-col md:items-center md:items-start lg:flex-row lg:justify-between'>
            <div className='hidden lg:block h-5 w-5 mr-2'>
              <svg
          ...
          <div className='mb-3 lg:mb-0 flex md:justify-center'>
            <div
              ...
              <div className='flex mx-1'>
                <div className='w-4 h-4'>
                  <svg
                    ...
                    style={{ fill: '#222222', right: 5, top: 2 }}
                    viewBox='0 0 512 512'
            ...
            <div className='hidden md:flex ml-8'>
              ...
              <div className='h-5 w-5 ml-4'>
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'
                  viewBox='0 0 512 512'
                  style={{ fill: '#484848', marginRight: 1 }}>
                  <g>
                    <path
