...
const renderContent = (type: string, mode: string) => {
  if (mode === 'white') {
    return (
        ...
        <nav
          ...
          <div className='border-transparent border-b-2 hover:border-white py-6 px-1'>
            <a
              ...
              <p style={{ fontFamily: 'airbnb-medium' }} className='text-white'>
                English(CA)
              </p>
            </a>
          </div>
...
export const ExploreHeader: React.FC<Prop> = ({ type, mode }) => {
  return <>{renderContent(type, mode)}</>;
};
