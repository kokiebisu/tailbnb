...
export const ExperiencesHeader = ({ switchMenuModal }) => {
  ...
  return (
    <>
      <div className='bg-white flex flex-wrap items-center justify-between h-20'>
        <div className='hidden lg:block h-8 w-8 ml-6 flex items-center'>
          <a href='/'>
            <svg
        ...
        <div className='hidden lg:block'>
          <nav
            ...
            <div className='border-transparent border-b-2 hover:border-white py-6 mx-2'>
              <a
                href='#'
            ...
            <div className='mx-2 flex items-center justify-center border-transparent border-b-2 hover:border-white py-6 px-1'>
              <Link href='/host/homes'>
                <a className='text-sm tracking-wide'>Become a host</a>
              </Link>
            </div>
            <div className='mx-2 flex items-center justify-center border-transparent border-b-2 hover:border-white py-6 px-1'>
              <button
            ...
            {/* {optionModal & !languageModal & !currencyModal ? (
              <>
                <div style={{ left: -140, top: 40 }} className='absolute z-50'>
                  <OptionModal
