...
// Images
const controlhostingQuote = require('../../../../public/img/high/host-steps-quote.jpg');

export const ControlHosting: React.FC<{}> = () => {
  return (
    <>
      <HostSection title='Control how you host'>
        <div>
