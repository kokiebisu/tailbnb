...
export const HostServicesHeader: React.FC<{}> = () => {
  return (
    <>
      <div
        style={{ top: 30, left: 0 }}
        ...
        <div className='ml-6 mr-3'>
          <a href='/'>
            ...
            <svg
              ...
              focusable='false'
              className='block'
              style={{ height: 34, width: 34, fill: '#ffffff' }}>
      ...
      <div className='px-4 md:px-0 flex bg-white w-full border-b border-gray-300 items-center justify-end lg:justify-between fixed bottom-0 border-t lg:sticky lg:top-0 z-50'>
        <div className='hidden lg:flex items-center justify-start'>
          ...
          <div
            ...
            <div className='mx-4 border-green-850 border-b-2 py-8 text-green-850'>
              <a href=''>Hosting services</a>
            </div>
          </div>
        </div>
        <div className='w-full lg:w-auto flex items-center py-3 lg:py-0 justify-between md:justify-end'>
          <div className='flex flex-col-reverse md:flex-row'>
            ...
            <div className='md:mx-1' id='monthly-potential'>
              <h3
          ...
          <div className='px-1 ml-2 md:mr-10 lg:mr-16'>
            <button
              style={{ fontFamily: 'airbnb-medium' }}
