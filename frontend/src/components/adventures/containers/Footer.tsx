  ...
  return (
    <div className='block bg-white w-full border-t border-gray-300'>
      <div className='lg:px-20 px-5 xl:px-0 lg:max-w-6xl xl:max-w-5.5xl mx-auto py-6 sm:py-12'>
        ...
        <div className='flex md:justify-center lg:justify-start w-full'>
          <div className='md:w-60p lg:w-auto flex md:flex-col-reverse lg:flex-row flex-wrap items-center justify-between sm:pt-5'>
            <div className='md:w-64 lg:w-auto flex md:justify-center flex-wrap items-center'>
              <div className='md:hidden lg:block h-5 w-5'>
                <svg
            ...
            <div className='md:flex hidden md:block md:items-center lg:justify-start lg:flex-wrap md:pb-2 lg:pb-0'>
              <div style={{ right: 1 }} className='flex relative lg:px-8'>
                <div className='flex px-2'>
                  <div className='h-3 w-3'>
                    <svg
                      className='relative self-center h-full w-full'
                      style={{ fill: '#000000', right: 5, top: 7 }}
                      viewBox='0 0 512 512'
                ...
                <div className='flex px-2'>
                  <div style={{ top: 2 }} className='h-3 w-3 relative'>
              ...
              <div className='flex pl-12'>
                ...
                <div className='h-5 w-5 ml-4'>
                  <svg
                    ...
                    xmlns='http://www.w3.org/2000/svg'
                    viewBox='0 0 512 512'
                    style={{ fill: '#222222', marginRight: 1 }}>
                    <g>
                      <path
    ...
    c-44.096,0-80-35.904-80-80c0-44.128,35.904-80,80-80s80,35.872,80,80C336,300.096,300.096,336,256,336z'
      ...
      <button className='flex items-center justify-start hover:bg-gray-100 bg-white z-10 shadow-xl fixed bottom-0 lg:right-0 ml-4 lg:mr-4 mb-3 rounded-lg py-2 px-4 font-semibold text-sm'>
        <div>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 512 512'
