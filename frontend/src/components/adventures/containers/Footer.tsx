  ...
  return (
    <div className='block bg-white w-full border-t border-gray-300'>
      <div className='lg:px-20 px-5 xl:px-0 lg:max-w-6xl xl:max-w-5.5xl mx-auto py-6 sm:py-12'>
        ...
        <div className='flex flex-wrap items-center justify-between sm:pt-5'>
          <div className='flex flex-wrap items-center'>
            ...
            <p className='pl-2 text-sm  text-gray-650 font-semibold'>
          ...
          <div className='hidden lg:flex lg:items-center lg:justify-start lg:flex-wrap'>
            <svg
              className='h-5 w-5'
              viewBox='0 0 512 512'
              width='512pt'
            ...
            <svg
              ...
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 512 512'
              style={{ fill: '#767676', marginRight: 1 }}>
              <g>
                <path
