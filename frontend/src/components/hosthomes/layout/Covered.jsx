...
export const Covered = () => {
  return (
    ...
    <HostSection title="We've got you covered">
      <div className='flex'>
        <CharacteristicCard title={null} description="We know it’s a priority to trust the people staying in your home. Airbnb allows you to set strict requirements for who can book and to get to know guests before their stay. If something does come up, though, we have your back. With our Host Guarantee covering property damage and our Host Protection Insurance for liability, you’re supported as a host throughout." link="Learn how Airbnb protects hosts" children={null}/>
      </div>
    </HostSection>
