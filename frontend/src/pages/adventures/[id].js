  ...
  return (
    <>
      ...
      <div className='w-full bg-black h-80v flex justify-center'>
        <div className='w-full max-w-6xl h-full bg-gray-500'>
          <div className='bg-red-500  h-1/2'> hello</div>
          <div className='bg-black w-full max-w-6xl h-1/2'>
            <div className='bg-gray-500 w-4/12 h-full'>
              <div className='bg-red-500 items-end justify-start pt-4 text-xs uppercase text-white'>
                2-Day Adventure
              </div>
              <div className='w-full text-4xl bg-blue-500 my-3 text-white '>
