...
const four = () => {
  return (
    <>
      ...
      <LocationStays location='Paris' />
      <LocationExperiences location='Tokyo' />
      <LocationStays location='Tokyo' />
      <LocationExperiences location='Los Angeles' />
      <LocationStays location='Los Angeles' />
      <div className='py-16 md:py-24 lg:py-32'>
        <MovePage page={4} first={false} last={false} />
      </div>
      <NewFooter />
    </>
  );
