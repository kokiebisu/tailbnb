  ...
  var renderhost = function renderhost(host_is_superhost) {
    if (host_is_superhost == 't') {
      return __jsx("div", {
        ...
        className: "uppercase mt-3 md:mt-0 border border-gray-800 rounded px-1 mt-1 text-xs",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 27
        },
        ...
        className: "sm:ml-2 mt-1 text-sm sm:my-2 text-gray-750 truncate",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 32
        },
...
//# sourceMappingURL=index.js.45bb4bea620239ed09ab.hot-update.js.map