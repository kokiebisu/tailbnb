...
var BottomNav = function BottomNav() {
  return __jsx("div", {
    className: "w-full bg-red-500 fixed bottom-0 z-50 h-18",
    __self: _this,
    __source: {
    ...
    className: "bg-blue-500 max-w-xs mx-auto",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6,
...
//# sourceMappingURL=index.js.0eefbeea82febedc55eb.hot-update.js.map