...
var ExploreHeader = function ExploreHeader(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, white ? __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    className: "px-6 md:px-10 xl:px-20 xl:max-w-12xl flex items-center justify-around relative border-b border-gray-300",
    __source: {
    ...
    className: "flex items-center w-full md:w-80p",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 90
    },
...
//# sourceMappingURL=stay.js.8d94a236fffbe02ff5ea.hot-update.js.map