...
var CalendarModal = function CalendarModal() {
  return __jsx("div", {
    ...
    className: "bg-red-550 flex items-center justify-around",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    },
    ...
    className: "border-gray-300 w-3 h-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "bg-green-850 grid grid-cols-7 text-gray-650 text-sm",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57
    },
...
//# sourceMappingURL=index.js.8e19eb1064d1efa7d4fb.hot-update.js.map