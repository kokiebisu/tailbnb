...
var Featured = function Featured() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("div", {
    className: "w-full px-6 md:px-8 lg:px-10 xl:px-20 xl:max-w-layout mx-auto relative my-16 md:px-16 lg:px-0",
    __source: {
    ...
    className: "w-full h-104 relative overflow-y-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 129
    },
    ...
    className: "grid",
    style: {
      transform: "translateX(-".concat(property.index * 485, "px)")
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 184
...
//# sourceMappingURL=2.js.d45cdf82bcc26aeb4ebc.hot-update.js.map