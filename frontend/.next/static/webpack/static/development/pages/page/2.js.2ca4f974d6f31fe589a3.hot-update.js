...
var ExploreHeader = function ExploreHeader(_ref) {
  ...
  var expandInput = function expandInput() {
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenLite"].to(inputbox, 0.6, {
      css: {
        width: '800px'
      },
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, white ? __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "bg-blue-500 w-full md:max-w-224 flex items-center justify-start",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 55
    },
    ...
    className: "bg-red-550 flex w-full md:w-120 items-center justify-start mr-7 py-3 px-4 shadow-md rounded",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 56
    },
...
//# sourceMappingURL=2.js.2ca4f974d6f31fe589a3.hot-update.js.map