...
var renderSkeleton = function renderSkeleton(number) {
  console.log('entered skeleton');
  var content = [];

  for (var i = 0; i < number; i++) {
    content.push(__jsx("div", {
      className: "w-full mr-3 mb-3 rounded my-8",
      __source: {
...
var Adventures = function Adventures(_ref2) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, __jsx(_wrapper_Section__WEBPACK_IMPORTED_MODULE_9__["Section"], {
    ...
    className: "grid gap-3 2xl:grid-cols-6 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 grid-cols-2 w-full h-72",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 110
    },
...
var SSkeletonPulseVertical = Object(styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(SSkeletonPulse)(_templateObject3());

/***/ })

})
//# sourceMappingURL=2.js.206069b267050bbd1946.hot-update.js.map