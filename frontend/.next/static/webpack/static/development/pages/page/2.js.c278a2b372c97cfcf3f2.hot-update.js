...
var FeaturedCard = function FeaturedCard(_ref) {
  var img = _ref.img,
      ...
      color = _ref.color;
  return __jsx("div", {
    className: "w-86v md:w-auto min-w-verylarge md:min-w-medium lg:min-w-large",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 90
    },
    ...
    className: "w-86v md:w-40v py-16",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 93
    },
    ...
    className: "uppercase text-sm md:text-3xl text-gray-850 whitespace-no-wrap",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 122
    },
...
//# sourceMappingURL=2.js.c278a2b372c97cfcf3f2.hot-update.js.map