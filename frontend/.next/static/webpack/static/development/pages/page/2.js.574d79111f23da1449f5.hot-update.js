...
var Featured = function Featured() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("div", {
    className: "lg:max-w-8.5xl md:max-4xl bg-red-550 mx-auto relative pt-16 mb-64 pb-16",
    __source: {
    ...
    style: {
      transform: "translateX(-".concat(property.index * (100 / featureds.length), "%)")
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 130
...
//# sourceMappingURL=2.js.574d79111f23da1449f5.hot-update.js.map