...
var ExploreHeader = function ExploreHeader(_ref) {
  ...
  var expandInput = function expandInput() {
    if (innerWidth < 640) {// TweenLite.to(inputbox, 0.4, {
      //   x: -50,
      //   ease: Power3.easeIn
      // });
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, white ? __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: " bg-red-550  flex items-center justify-start w-full md:w-80p",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 108
    },
...
//# sourceMappingURL=2.js.e76d5d6112ef5bf96af9.hot-update.js.map