...
var Featured = function Featured() {
  ...
  var prevSlide = function prevSlide() {
    if (activeIndex === 0) {
      return setState(_objectSpread({}, state, {
        translate: featureds.length * getWidth(),
        activeIndex: featureds.length - 2
      }));
    }

    setState(_objectSpread({}, state, {
      activeIndex: activeIndex - 1,
      translate: (activeIndex - 1) * getWidth() / 8
    }));
  };
...
//# sourceMappingURL=2.js.f6f9bc086b0e5efda8bc.hot-update.js.map