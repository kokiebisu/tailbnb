...
var MenuModal = function MenuModal(_ref) {
  ...
  var arrow = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(null);
  var menu = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(null);
  var logo = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(null);
  ...
  function sleepProp() {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function sleepProp$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(sleep(3000));
  ...
  var turnOnMenu = function turnOnMenu() {
    gsap__WEBPACK_IMPORTED_MODULE_5__["TweenMax"].from(menu, 0.8, {
      height: 0
    });
    gsap__WEBPACK_IMPORTED_MODULE_5__["TweenMax"].from(arrow, 1, {
      rotation: '180_cw',
      opacity: 0.3,
      ease: gsap__WEBPACK_IMPORTED_MODULE_5__["Power3"].easeOut
    });
    gsap__WEBPACK_IMPORTED_MODULE_5__["TweenMax"].from(logo, 0.6, {
      fill: '#ffffff',
      opacity: 0,
      ease: gsap__WEBPACK_IMPORTED_MODULE_5__["Power3"].easeInOut
    });
  };
  ...
  var closeMenu = function closeMenu() {
    gsap__WEBPACK_IMPORTED_MODULE_5__["TweenMax"].to(menu, 0.7, {
      height: 0
    });
    gsap__WEBPACK_IMPORTED_MODULE_5__["TweenMax"].to(logo, 0.9, {
      fill: '#ffffff',
      ease: gsap__WEBPACK_IMPORTED_MODULE_5__["Power3"].easeInOut
    });
    sleepProp();
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3__["Fragment"], null, __jsx("div", (_jsx = {
    ref: function ref(el) {
      return menu = el;
    },
    className: "h-full"
  }, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_jsx, "className", "bg-white w-full fixed top-0 absolute z-100 overflow-hidden overflow-y-scroll"), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_jsx, "__source", {
...
//# sourceMappingURL=index.js.7005cac3b0d712dc1d5e.hot-update.js.map