...
var CalendarModal = function CalendarModal(_ref) {
  var setCheckInDate = _ref.setCheckInDate,
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(currentYear),
      ...
      setDisplayedYear = _useState3[1]; // Selected


  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(currentDate),
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    setCheckInDate([selectedDate, displayedMonth + 1, displayedYear]);
  }, [selectedDate]);
  return __jsx("div", {
    style: {
      top: 55
    ...
    __self: this
  }, Object(_util_CalendarModalFunctions__WEBPACK_IMPORTED_MODULE_1__["generateUnexistingDays"])(Object(_util_CalendarModalFunctions__WEBPACK_IMPORTED_MODULE_1__["getStartingDay"])(displayedMonth, displayedYear)), Object(_util_CalendarModalFunctions__WEBPACK_IMPORTED_MODULE_1__["generateUnavailableDays"])(1, displayedDate), generateAvailableDays(displayedDate, Object(_util_CalendarModalFunctions__WEBPACK_IMPORTED_MODULE_1__["getEndingDate"])(displayedMonth, displayedYear).getDate(), setSelectedDate, closeModal))));
};

var generateAvailableDays = function generateAvailableDays(today, lastday, setSelectedDate, closeModal) {
  var result = [];
...
//# sourceMappingURL=index.js.3a2ec6793ee43637e76c.hot-update.js.map