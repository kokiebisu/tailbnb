...
var Banner = function Banner() {
  return __jsx("div", {
    ...
    className: "h-full w-2/7 border-r-4 border-white relative bg-cover bg-no-repeat overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "h-40v w-2/7 border-l-4 border-r-4 border-white relative bg-cover bg-no-repeat relative overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20
    },
...
//# sourceMappingURL=[id].js.e2c97fdf952f6541ea1d.hot-update.js.map