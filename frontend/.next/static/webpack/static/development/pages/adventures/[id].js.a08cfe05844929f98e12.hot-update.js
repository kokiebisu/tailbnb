...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const API_URL = 'https://api.unsplash.com/photos/random/?client_id=RchVxgkvTlsApnvD7fdLAxFzqAa0yi6OPLS3pTWs3W4,client_secret=itaZc8B-qpxEh4q-OPI3jBP_SGQnRPB_DTEGzli26Lc';

  const loadData = async () => {
    const response = await fetch(API_URL, {});
    console.log(response); // setPhoto(response.url);
    // setIsLoading(false);
  };
...
//# sourceMappingURL=[id].js.a08cfe05844929f98e12.hot-update.js.map