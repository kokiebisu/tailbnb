...
var AdventureCard = function AdventureCard(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, position === 'first' ? __jsx("div", {
    ...
    className: "text-sm md:text-base mt-1 md:-mt-1 ml-4 lg:ml-0 lg:mt-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 161
    },
    ...
    className: "text-sm mt-1 md:-mt-1 ml-4 lg:ml-0 lg:mt-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 175
    },
...
//# sourceMappingURL=[id].js.41113a2d73b98d910ec2.hot-update.js.map