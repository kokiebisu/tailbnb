...
var id = function id() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_4___default.a, {
    ...
    className: "w-full lg:max-w-6xl flex justify-start items-start flex-wrap py-16 bg-gray-350 rounded-xl",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 76
    },
    ...
    className: "flex justify-start items-center bg-red-500 h-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 80
    },
...
//# sourceMappingURL=[id].js.3109160323d7857bc7b4.hot-update.js.map