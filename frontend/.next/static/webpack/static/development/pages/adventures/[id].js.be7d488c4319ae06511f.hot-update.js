...
var id = function id() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_4___default.a, {
    ...
    className: "w-full lg:max-w-6xl flex justify-start items-start flex-wrap py-12",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62
    },
    ...
    className: "bg-red-500 w-full md:w-8/12 px-4",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 68
    },
...
//# sourceMappingURL=[id].js.be7d488c4319ae06511f.hot-update.js.map