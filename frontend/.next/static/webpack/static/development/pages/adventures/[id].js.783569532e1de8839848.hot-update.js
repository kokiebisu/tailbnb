...
var Safety = function Safety() {
  return __jsx("div", {
    ...
    className: "px-4 md:px-16 w-full max-w-6xl xl:px-0 flex justify-start items-start flex-wrap h-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "bg-red-300 flex justify-start items-center h-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    },
    ...
    className: "text-2xl md:text-3xl text-gray-750 bg-red-500",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
    },
...
//# sourceMappingURL=[id].js.783569532e1de8839848.hot-update.js.map