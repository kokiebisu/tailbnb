...
var WhatYouDo = function WhatYouDo() {
  return __jsx("div", {
    ...
    className: "px-16 w-full max-w-6xl xl:px-0 flex justify-start items-start flex-wrap py-16",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
    ...
    className: "bg-red-500 md:w-4/12 h-full ",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "w-2/3 text-3xl text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
...
//# sourceMappingURL=[id].js.c2b0bf2b714302ca9919.hot-update.js.map