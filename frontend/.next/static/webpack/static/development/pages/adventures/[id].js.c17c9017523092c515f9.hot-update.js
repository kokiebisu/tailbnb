...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "hidden md:block lg:flex lg:flex-wrap lg:items-start lg::w-full md:mx-6 lg:mx-0 md:justify-between md:pb-6 lg:pb-10 md:border-b md:border-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "md:w-1/2 lg:w-auto flex md:justify-center md:flex-col-reverse lg:flex-row flex-wrap items-center justify-between sm:pt-5",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 189
    },
    ...
    className: "bg-green-850 flex flex-wrap items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 190
    },
...
//# sourceMappingURL=[id].js.c17c9017523092c515f9.hot-update.js.map