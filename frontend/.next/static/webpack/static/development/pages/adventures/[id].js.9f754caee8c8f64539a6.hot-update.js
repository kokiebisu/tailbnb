...
var KeepInMindCard = function KeepInMindCard(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, order === 'top' ? __jsx("div", {
    className: "bg-red-200 items-center w-full flex pb-6 border-b border-gray-300",
    __source: {
    ...
    className: "hidden md:block text-green-850 text-sm my-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32
    },
    ...
    className: "w-full flex pb-6 pt-6 border-b border-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 64
    },
...
//# sourceMappingURL=[id].js.9f754caee8c8f64539a6.hot-update.js.map