...
var Host = function Host() {
  return __jsx("div", {
    className: "bg-blue-500 w-full flex justify-center",
    __source: {
    ...
    className: "w-full md:w-8/12 md:px-4 text-gray-750 text-lg bg-blue-200",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15
    },
    ...
    className: "my-68h-32 w-32 md:mb-12",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
    },
...
//# sourceMappingURL=[id].js.2bc8b8ec1f37a86adcea.hot-update.js.map