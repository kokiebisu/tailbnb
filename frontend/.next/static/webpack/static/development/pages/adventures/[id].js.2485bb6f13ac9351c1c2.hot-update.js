...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    unsplash.search.getRandomPhoto('home').then(unsplash_js__WEBPACK_IMPORTED_MODULE_4__["toJson"]).then(json => {
      let photoTempArray = [];

      for (let i = 0; i < 10; i++) {
        photoTempArray.push(json.results[i].urls.small);
      }
...
//# sourceMappingURL=[id].js.2485bb6f13ac9351c1c2.hot-update.js.map