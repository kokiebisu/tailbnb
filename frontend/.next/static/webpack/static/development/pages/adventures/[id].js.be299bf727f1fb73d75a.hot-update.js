...
var Banner = function Banner() {
  return __jsx("div", {
    ...
    className: "h-35v w-2/7 border-r-4 border-white relative bg-contain bg-no-repeat overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "h-35v w-2/7 border-r-4 border-white relative bg-auto bg-no-repeat overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20
    },
...
//# sourceMappingURL=[id].js.be299bf727f1fb73d75a.hot-update.js.map