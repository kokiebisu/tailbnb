...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "w-full md:items-center flex-col-reverse flex md:justify-center lg:justify-start w-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 189
    },
    ...
    className: "md:w-60p lg:w-full flex md:flex-col-reverse lg:flex-row flex-wrap items-center justify-between sm:pt-5",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 190
    },
    ...
    className: "w-full md:w-64 lg:w-auto md:flex md:justify-center flex-wrap items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 191
    },
    ...
    className: "bg-red-550 w-full md:w-auto md:pl-2 text-sm text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 206
    },
    ...
    className: "md:pl-2 text-sm text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 219
    },
    ...
    className: "flex flex-col-reverse md:flex-row md:items-center lg:justify-start lg:flex-wrap md:pb-2 lg:pb-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 256
    },
    ...
    className: "hidden md:flex pl-12",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 289
    },
...
//# sourceMappingURL=[id].js.84565581834fa91534d3.hot-update.js.map