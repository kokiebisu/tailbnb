...
var Itinerary = function Itinerary() {
  return __jsx("div", {
    ...
    className: "bg-gray-200 px-4 md:px-16 w-full max-w-6xl flex justify-start items-start flex-wrap py-16",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "bg-red-500 text-2xl w-full md:w-4/12 h-full md:text-3xl text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
...
//# sourceMappingURL=[id].js.398f54813cac894109e9.hot-update.js.map