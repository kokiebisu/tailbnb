...
var DateCheck = function DateCheck() {
  return __jsx("div", {
    className: "bg-white w-screen py-2 sticky bottom-0 z-50 absolute flex justify-between px-8 items-center",
    __source: {
    ...
    className: "text-gray-650 text-xs tracking-tight md:hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 51
    },
...
//# sourceMappingURL=[id].js.e58b8f5baf49c78fb49e.hot-update.js.map