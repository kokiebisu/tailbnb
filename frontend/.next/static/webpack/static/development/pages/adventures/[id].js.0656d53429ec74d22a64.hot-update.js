...
var Included = function Included() {
  return __jsx("div", {
    className: "h-full px-6 md:px-16 lg:px-0 xl:max-w-6xl mx-auto py-5 lg:py-16 overflow-x-hidden overflow-y-hidden lg:flex",
    __source: {
    ...
    className: "py-8 md:py-0 md:w-4/12 h-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "md:h-full bg-blue-500",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
...
//# sourceMappingURL=[id].js.0656d53429ec74d22a64.hot-update.js.map