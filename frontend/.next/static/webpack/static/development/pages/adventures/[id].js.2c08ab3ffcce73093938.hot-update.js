...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "hidden md:block lg:flex lg:flex-wrap lg:items-start lg::w-full md:mx-6 lg:mx-0 md:justify-between md:pb-6 lg:pb-10 md:border-none",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
...
//# sourceMappingURL=[id].js.2c08ab3ffcce73093938.hot-update.js.map