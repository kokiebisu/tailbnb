...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "lg:px-20 px-5 xl:px-0 lg:max-w-6xl xl:max-w-5.5xl mx-auto py-1 sm:py-12",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
    ...
    className: "hidden md:block lg:flex lg:flex-wrap lg:items-start lg::w-full md:mx-6 lg:mx-0 md:justify-between md:pb-6 lg:pb-10 lg:border-b md:border-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
...
//# sourceMappingURL=[id].js.17aa60304be6bb5b43ce.hot-update.js.map