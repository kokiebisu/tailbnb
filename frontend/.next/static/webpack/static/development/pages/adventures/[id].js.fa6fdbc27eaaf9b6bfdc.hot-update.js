...
var Adventures = function Adventures() {
  return __jsx("div", {
    ...
    className: "bg-red-500 w-full lg:max-w-6xl md:flex justify-start items-start flex-wrap py-16 lg:py-32",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
...
//# sourceMappingURL=[id].js.fa6fdbc27eaaf9b6bfdc.hot-update.js.map