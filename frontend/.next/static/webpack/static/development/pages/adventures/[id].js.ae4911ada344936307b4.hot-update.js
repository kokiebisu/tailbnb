...
var Included = function Included() {
  return __jsx("div", {
    className: "px-6 md:px-8 lg:px-10 xl:px-20 xl:max-w-7xl mx-auto py-5 overflow-x-hidden overflow-y-hidden",
    __source: {
    ...
    className: "px-4 md:px-16 w-full xl:px-0 flex justify-start items-start flex-wrap py-8 md:py-16",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
...
//# sourceMappingURL=[id].js.ae4911ada344936307b4.hot-update.js.map