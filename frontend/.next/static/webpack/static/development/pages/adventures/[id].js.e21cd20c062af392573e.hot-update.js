...
var Included = function Included() {
  return __jsx("div", {
    className: "bg-red-550 px-6 md:px-16 lg:px-0 xl:max-w-6xl mx-auto py-5 overflow-x-hidden overflow-y-hidden flex",
    __source: {
    ...
    className: "py-8 md:py-16 md:w-4/12",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
...
//# sourceMappingURL=[id].js.e21cd20c062af392573e.hot-update.js.map