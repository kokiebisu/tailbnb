...
var renderContent = function renderContent(type, mode) {
  if (mode === 'white') {
    ...
    return __jsx("div", {
      ...
      className: "text-white  hidden xl:block xl:flex items-center justify-around flex-wrap text-gray-750",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 120
      },
...
//# sourceMappingURL=[id].js.b216d81c65795386a7a1.hot-update.js.map