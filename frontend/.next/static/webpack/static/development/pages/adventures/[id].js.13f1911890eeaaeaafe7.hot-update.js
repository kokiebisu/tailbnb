...
var id = function id() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_4___default.a, {
    ...
    className: "bg-blue-500 w-full max-w-6xl h-1/2",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62
    },
    ...
    className: "bg-red-500 items-end justify-start pt-4 text-sm uppercase text-white",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 64
    },
    __self: this
  }, "2-Day Adventure"))))), __jsx(_components_layout_Footer__WEBPACK_IMPORTED_MODULE_8__["Footer"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 71
    },
...
//# sourceMappingURL=[id].js.13f1911890eeaaeaafe7.hot-update.js.map