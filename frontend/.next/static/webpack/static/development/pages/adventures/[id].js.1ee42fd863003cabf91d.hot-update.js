...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "justify-start bg-green-850 flex md:justify-center lg:justify-start w-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 189
    },
    ...
    className: "justify-start md:w-60p lg:w-auto flex flex-col-reverse lg:flex-row flex-wrap items-center md:justify-between sm:pt-5",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 190
    },
    ...
    className: "bg-red-550 flex md:flex-row md:items-center lg:justify-start lg:flex-wrap md:pb-2 lg:pb-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 252
    },
...
//# sourceMappingURL=[id].js.1ee42fd863003cabf91d.hot-update.js.map