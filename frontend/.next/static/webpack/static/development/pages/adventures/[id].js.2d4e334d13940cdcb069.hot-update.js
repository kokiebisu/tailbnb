...
var DateCheck = function DateCheck() {
  return __jsx("div", {
    className: "bg-white w-screen py-4 sticky bottom-0 z-50 absolute flex justify-between px-8",
    __source: {
    ...
    className: "px-8 bg-red-550 py-3 md:px-16 rounded",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22
    },
...
//# sourceMappingURL=[id].js.2d4e334d13940cdcb069.hot-update.js.map