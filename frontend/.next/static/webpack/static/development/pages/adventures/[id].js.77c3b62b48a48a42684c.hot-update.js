...
var Banner = function Banner() {
  return __jsx("div", {
    ...
    className: "w-full bg-red-500 min-h-40 h-40v flex",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12
    },
    ...
    className: "h-40v w-full md:w-2/7 border-r-4 border-white relative bg-cover bg-no-repeat overflow-hidden rounded",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "rounded w-full border-l-4 border-white md:w-2/7 relative overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25
    },
...
//# sourceMappingURL=[id].js.77c3b62b48a48a42684c.hot-update.js.map