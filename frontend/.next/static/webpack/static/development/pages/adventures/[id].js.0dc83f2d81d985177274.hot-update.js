...
var Included = function Included() {
  return __jsx("div", {
    className: "px-6 md:px-16 lg:px-0 xl:max-w-6xl mx-auto py-5 lg:py-16 overflow-x-hidden overflow-y-hidden lg:flex",
    __source: {
    ...
    className: "mb-16 md:h-full bg-blue-500",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
...
//# sourceMappingURL=[id].js.0dc83f2d81d985177274.hot-update.js.map