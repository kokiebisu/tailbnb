...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "hidden lg:flex lg:flex-wrap lg:items-start lg::w-full md:justify-between md:pb-6 lg:pb-10 md:border-b md:border-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
...
//# sourceMappingURL=[id].js.6e4ec7f8164f984a93fe.hot-update.js.map