...
var KeepInMind = function KeepInMind() {
  return __jsx("div", {
    ...
    className: "mb-8 md:mb-0 w-2/3 md:w-4/12 md:h-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
    ...
    className: "lg:sticky top-0 text-2xl md:text-3xl text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
...
//# sourceMappingURL=[id].js.dc1a86825d47b1fe89f0.hot-update.js.map