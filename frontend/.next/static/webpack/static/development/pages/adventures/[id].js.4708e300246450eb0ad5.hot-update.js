...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "hidden md:block lg:flex lg:flex-wrap lg:items-start lg::w-full md:justify-between md:pb-6 lg:pb-10 md:border-b md:border-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
...
//# sourceMappingURL=[id].js.4708e300246450eb0ad5.hot-update.js.map