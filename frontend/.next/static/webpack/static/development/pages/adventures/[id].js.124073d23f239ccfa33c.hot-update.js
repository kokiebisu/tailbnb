...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "hidden md:flex md:flex-wrap md:items-start md:w-full md:justify-between md:pb-6 lg:pb-8 md:border-b md:border-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
...
//# sourceMappingURL=[id].js.124073d23f239ccfa33c.hot-update.js.map