...
var Banner = function Banner() {
  return __jsx("div", {
    ...
    className: "w-full bg-red-500 min-h-40 h-35v flex",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12
    },
    ...
    className: "h-35vv w-2/7 border-r-4 border-white relative bg-cover bg-no-repeat overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "rounded border-r-4 border-white w-1/7 relative overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27
    },
...
//# sourceMappingURL=[id].js.c9900a6516f8cd14c5ec.hot-update.js.map