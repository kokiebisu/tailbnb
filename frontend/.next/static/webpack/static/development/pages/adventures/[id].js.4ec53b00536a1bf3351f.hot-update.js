...
var id = function id() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_4___default.a, {
    ...
    className: "w-full lg:max-w-6xl flex justify-start items-start flex-wrap py-16 bg-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 64
    },
    ...
    __self: this
  }, "During the two days trek you will get the chance to learn howto cook certain dishes in addition to tea making ceremony")))), __jsx(_components_layout_Footer__WEBPACK_IMPORTED_MODULE_10__["Footer"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 96
    },
...
//# sourceMappingURL=[id].js.4ec53b00536a1bf3351f.hot-update.js.map