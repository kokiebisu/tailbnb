...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "flex-col-reverse flex items-center md:justify-center lg:justify-start w-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 189
    },
    ...
    className: "w-full md:w-60p lg:w-auto flex flex-col-reverse lg:flex-row flex-wrap items-center justify-between sm:pt-5",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 190
    },
    ...
    className: "w-full flex md:flex-row md:items-center lg:justify-start lg:flex-wrap pb-3 md:pb-2 lg:pb-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 252
    },
...
//# sourceMappingURL=[id].js.29ff02dabc3013b48d26.hot-update.js.map