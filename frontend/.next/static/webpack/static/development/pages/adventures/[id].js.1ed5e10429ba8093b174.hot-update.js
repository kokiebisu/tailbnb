...
var Banner = function Banner() {
  return __jsx("div", {
    ...
    className: "w-full lg:max-w-6xl flex justify-start items-start flex-wrap relative top-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 51
    },
    ...
    className: "w-full md:w-1/2 lg:w-4/12 bg-green-850",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 52
    },
    ...
    className: "bg-red-100 w-full md:w-1/2 lg:w-8/12 pb-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 95
    },
    ...
    className: "bg-blue-400 w-full md:w-9/12 mt-4",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 96
    },
    ...
    className: "bg-red-500 w-full lg:w-8/12 absolute right-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 104
    },
...
//# sourceMappingURL=[id].js.1ed5e10429ba8093b174.hot-update.js.map