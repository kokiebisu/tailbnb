...
var Adventures = function Adventures() {
  return __jsx("div", {
    ...
    className: "w-full lg:max-w-6xl md:w-4/12 md:flex justify-start items-start flex-wrap py-16 lg:py-32",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
    ...
    className: "w-full pb-10 border-b border-gray-300 md:border-none",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    },
    ...
    className: "bg-red-400 md:w-4/12 h-full flex md:items-start lg:items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12
    },
    ...
    className: "text-3xl md:text-3xl lg:text-5xl text-gray-750 leading-none ",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15
    },
    ...
    className: "bg-red-300 w-full md:w-8/12 text-gray-750 lg:flex",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21
    },
...
//# sourceMappingURL=[id].js.6bcd54a4523e867f7e37.hot-update.js.map