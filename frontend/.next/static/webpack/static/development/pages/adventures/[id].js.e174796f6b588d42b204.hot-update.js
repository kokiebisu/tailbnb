...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "bg-green-850 hidden md:block lg:flex lg:flex-wrap lg:items-start lg::w-full md:mx-6 lg:mx-0 md:justify-between md:pb-6 lg:pb-10 md:border-b md:border-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "lg:w-1/4 md:border-b border-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    },
...
//# sourceMappingURL=[id].js.e174796f6b588d42b204.hot-update.js.map