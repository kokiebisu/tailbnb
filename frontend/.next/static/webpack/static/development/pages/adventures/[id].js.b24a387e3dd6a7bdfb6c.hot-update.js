...
var WhatYouDo = function WhatYouDo() {
  return __jsx("div", {
    ...
    className: "bg-red-500 md:w-4/12 md:h-full ",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "w-2/3 text-xl mb-12 md:text-3xl text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
...
//# sourceMappingURL=[id].js.b24a387e3dd6a7bdfb6c.hot-update.js.map