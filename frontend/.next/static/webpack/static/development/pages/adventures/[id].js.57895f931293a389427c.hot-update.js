...
var Included = function Included() {
  return __jsx("div", {
    ...
    className: "bg-blue-500 px-4 md:px-16 w-full max-w-6xl xl:px-0 flex justify-start items-start flex-wrap py-16",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "bg-blue-700 w-full md:w-4/12 md:h-full text-2xl md:text-3xl text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
    ...
    className: "bg-red-300 w-full md:w-8/12 px-4 text-gray-750 flex overflow-x-hidden overflow-y-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15
    },
    ...
    className: "bg-red-500 w-full lg:w-1/3 pb-5 mr-2",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22
    },
...
//# sourceMappingURL=[id].js.57895f931293a389427c.hot-update.js.map