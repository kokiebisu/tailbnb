...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const loadData = async () => {
    axios__WEBPACK_IMPORTED_MODULE_4___default.a.get(`https://api.unsplash.com/search/photos/?page=1&per_page=10&query=${query}&client_id=${cred.APP_ID}`).then(data => {
      setPhotos({
...
//# sourceMappingURL=[id].js.84df14a6c32ad3e11a09.hot-update.js.map