...
var AdventureCard = function AdventureCard(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, position === 'first' ? __jsx("div", {
    ...
    className: "pt-4 md:pt-0 md:pb-4 w-full flex lg:block lg:w-1/3 lg:mt-4 pr-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 166
    },
    ...
    className: "pt-4 w-full flex lg:block lg:w-1/3 lg:mt-4 pr-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 176
    },
...
//# sourceMappingURL=[id].js.7b580ddbf49ce964895a.hot-update.js.map