...
var Adventures = function Adventures() {
  return __jsx("div", {
    ...
    className: "py-8 w-full lg:max-w-6xl md:flex justify-start items-start flex-wrap md:py-16 lg:py-32",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
    ...
    className: "md:w-4/12 w-full md:pb-10 border-b border-gray-300 md:border-none",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12
    },
...
//# sourceMappingURL=[id].js.b8abe6fc9f1a0317cc8d.hot-update.js.map