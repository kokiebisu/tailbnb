...
var Banner = function Banner() {
  return __jsx("div", {
    ...
    className: "px-16 w-full xl:px-0 max-w-6xl",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    },
    ...
    className: "bg-red-500 h-1/2 flex",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12
    },
    ...
    className: "w-full md:w-2/7 border-r-4 border-white relative bg-cover bg-no-repeat overflow-hidden  rounded",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "rounded w-full border-l-4 border-r-4 border-white md:w-2/7 relative overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    },
    ...
    className: "rounded w-full border-l-4 border-r-4 border-white md:w-1/7 relative overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15
    },
    ...
    className: "rounded w-full border-l-4 border-b-4 border-r-4 border-white md:w-2/7 relative overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16
    },
...
//# sourceMappingURL=[id].js.78ea6cac64c6b5a0e484.hot-update.js.map