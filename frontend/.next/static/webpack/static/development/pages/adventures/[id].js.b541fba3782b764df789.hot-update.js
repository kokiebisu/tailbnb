...
var Adventures = function Adventures() {
  return __jsx("div", {
    ...
    className: "px-16 max-w-6xl xl:px-0 w-full flex justify-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "bg-red-500 md:w-4/12 h-full flex md:items-start lg:items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    },
...
//# sourceMappingURL=[id].js.b541fba3782b764df789.hot-update.js.map