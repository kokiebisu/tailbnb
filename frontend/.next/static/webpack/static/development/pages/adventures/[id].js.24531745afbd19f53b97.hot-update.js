...
var Banner = function Banner() {
  return __jsx("div", {
    ...
    className: "w-full lg:w-2/7 border-r-4 border-white relative bg-cover bg-no-repeat overflow-hidden  rounded",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "rounded w-full border-l-4 border-b-4 border-r-4 border-white md:w-1/2 relative overflow-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    },
...
//# sourceMappingURL=[id].js.24531745afbd19f53b97.hot-update.js.map