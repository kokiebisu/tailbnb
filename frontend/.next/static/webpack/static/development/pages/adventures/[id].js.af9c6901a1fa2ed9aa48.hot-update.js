...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "bg-green-850 md:w-1/2 lg:w-auto flex md:flex-col-reverse lg:flex-row flex-wrap items-center justify-between sm:pt-5",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 189
    },
    ...
    className: "md:w-70p lg:w-auto flex md:justify-center flex-wrap items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 190
    },
    ...
    className: "md:w-full hidden md:block lg:flex lg:items-center lg:justify-start lg:flex-wrap",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 251
    },
    ...
    className: "md:w-1/2 lg:w-auto flex relative px-8 bg-red-550",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 252
    },
...
//# sourceMappingURL=[id].js.af9c6901a1fa2ed9aa48.hot-update.js.map