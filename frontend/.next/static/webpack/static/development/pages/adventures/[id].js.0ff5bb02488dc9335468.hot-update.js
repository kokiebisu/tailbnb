...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "bg-green-850 hidden md:block lg:flex lg:flex-wrap lg:items-start lg::w-full md:px-6 md:justify-between md:pb-6 lg:pb-10 md:border-b md:border-gray-300",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
...
//# sourceMappingURL=[id].js.0ff5bb02488dc9335468.hot-update.js.map