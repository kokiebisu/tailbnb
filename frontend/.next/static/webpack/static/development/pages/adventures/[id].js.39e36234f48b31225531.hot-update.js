...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "w-full md:items-center md:flex-col-reverse md:flex md:justify-center lg:justify-start w-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 189
    },
    ...
    className: "md:w-60p lg:w-full flex md:flex-col-reverse lg:flex-row items-center justify-between sm:pt-5",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 190
    },
...
//# sourceMappingURL=[id].js.39e36234f48b31225531.hot-update.js.map