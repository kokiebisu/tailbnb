...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "md:w-60p lg:w-auto flex flex-col-reverse lg:flex-row flex-wrap items-center md:justify-between sm:pt-5",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 190
    },
    ...
    className: "bg-red-550 w-90p md:w-64 lg:w-auto flex md:justify-center flex-wrap items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 191
    },
...
//# sourceMappingURL=[id].js.58c50b3a139aeec0a6a4.hot-update.js.map