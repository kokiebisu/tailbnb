...
var CalendarModal = function CalendarModal() {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(today.getMonth()),
      currentMonth = _useState[0],
      setCurrentMonth = _useState[1];
  ...
  return __jsx("div", {
    ...
    __self: this
  }, month[date.getMonth()], " ", date.getFullYear()))), __jsx("button", {
    onClick: function onClick(e) {
      e.preventDefault();
...
//# sourceMappingURL=index.js.3a0c945dfd842c3ce23c.hot-update.js.map