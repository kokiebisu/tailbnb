  ...
  function renderPhrase(phrase) {
    if (phrase) {
      return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("h3", {
        ...
        className: "scrollable text-gray-750 text-xl pt-3 w-5/6",
        __source: {
        ...
        className: "scrollable text-md mb-5 text-gray-750 pb-3",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 23
        },
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("h3", {
        ...
        className: "scrollable text-gray-850 text-xl py-3 w-5/6",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 33
        },
...
//# sourceMappingURL=index.js.5fccb6ce5982a1fe9dda.hot-update.js.map