...
var SectionOverflow = function SectionOverflow(_ref) {
  ...
  function renderPhrase(phrase) {
    if (phrase) {
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("h3", {
        ...
        className: "bg-blue-500 scrollable text-gray-850 text-2xl py-3 w-5/6",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 33
        },
  ...
  return __jsx("div", {
    className: "bg-red-550 sm:px-6 lg:px-20 lg:max-w-layout mx-auto py-5 overflow-x-hidden overflow-y-hidden",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43
    },
...
//# sourceMappingURL=index.js.7d5af08d78d10fa40494.hot-update.js.map