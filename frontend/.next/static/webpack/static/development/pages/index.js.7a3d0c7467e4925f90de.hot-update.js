...
var CalendarModal = function CalendarModal() {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(currentDate),
      displayedMonth = _useState[0],
      setDisplayedMonth = _useState[1];

  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(currentDate),
      displayedDate = _useState2[0],
      setDisplayedDate = _useState2[1];
  ...
  return __jsx("div", {
    ...
    onClick: function onClick(e) {
      ...
      if (currentMonth === 0) {
        console.log('entered currentmonth = 1');
        setCurrentMonth(11);
    ...
    onClick: function onClick(e) {
      ...
      setCurrentMonth(currentMonth + 1, function () {});
    },
    className: "border py-2 px-3",
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.7a3d0c7467e4925f90de.hot-update.js.map