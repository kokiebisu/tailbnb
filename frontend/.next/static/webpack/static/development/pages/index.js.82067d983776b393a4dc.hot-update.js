...
var mapSizesToProps = function mapSizesToProps(_ref) {
  ...
  return {
    isMobile: width < 756,
    isTablet: width > 756 && width < 987,
    isLaptop: width > 987 && width < 1529,
    isDesktop: width > 1529
  };
};
...
var renderContent = function renderContent(data, number) {
  ...
  for (var i = 0; i < number; i++) {
    content.push(__jsx("div", {
      className: "w-full sm:w-1/3 md:w-1/4 lg:w-1/5 xl:w-1/6 pb-5",
      __source: {
...
var Today = function Today(_ref2) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, __jsx(_wrapper_Section__WEBPACK_IMPORTED_MODULE_8__["Section"], {
    ...
    __self: this
  })) : data && __jsx(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, isMobile ? renderContent(data, 4) : null, isTablet ? renderContent(data, 3) : null, isLaptop ? renderContent(data, 4) : null)), __jsx(_ShowAll__WEBPACK_IMPORTED_MODULE_7__["ShowAll"], {
...
//# sourceMappingURL=index.js.82067d983776b393a4dc.hot-update.js.map