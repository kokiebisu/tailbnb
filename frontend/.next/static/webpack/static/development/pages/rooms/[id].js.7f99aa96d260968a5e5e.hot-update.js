...
/* harmony default export */ __webpack_exports__["default"] = (({
  ...
  }, "Add dates for prices"), loading ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    style: {
      fontFamily: 'airbnb-medium'
    },
    className: "px-4 lg:px-0 lg:w-full bg-pink-850 text-white rounded-lg py-3 whitespace-no-wrap"
  }, "Check Availability") : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    style: {
      fontFamily: 'airbnb-medium'
    },
    className: "flex justify-centerpx-4 lg:px-0 lg:w-full bg-pink-850 text-white rounded-lg py-3 whitespace-no-wrap"
...
//# sourceMappingURL=[id].js.7f99aa96d260968a5e5e.hot-update.js.map