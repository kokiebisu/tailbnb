...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  const renderDescription = description => {
    if (description.length > 100) {
      ...
      return `description${react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", null, "Read more")}`;
    }
  };

  const description = 'As we pulled into the driveway, we knew it was an incredible place.';
...
//# sourceMappingURL=[id].js.01b8269d03d7bf732b32.hot-update.js.map