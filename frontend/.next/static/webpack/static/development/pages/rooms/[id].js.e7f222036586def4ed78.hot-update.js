...
/* harmony default export */ __webpack_exports__["default"] = (({
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "left-0 bg-blue-500 w-full z-50 fixed bottom-0 bg-white w-full lg:block lg:w-25/31 lg:sticky lg:top-0 flex lg:justify-center lg:mt-5 lg:ml-10"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "w-full lg:flex-col flex mx-10 items-center bg-red-500 justify-between"
    ...
    className: "text-sm lg:w-full py-5 lg:text-2xl text-gray-850"
...
//# sourceMappingURL=[id].js.e7f222036586def4ed78.hot-update.js.map