...
var generateAvailableDays = function generateAvailableDays(today, lastday) {
  console.log(today);
  console.log(lastday); // var result = [];
  // for (var i = today; i <= lastday; i++) {
  //   result.push(
  //     <div className='border border-gray-650 flex justify-center'>
...
//# sourceMappingURL=index.js.a4b0feb66230b0d95257.hot-update.js.map