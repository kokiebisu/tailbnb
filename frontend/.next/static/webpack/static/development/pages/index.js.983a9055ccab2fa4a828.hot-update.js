...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  function useForceUpdate() {
    const [, setTick] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(0);
  ...
  }, matches => matches.small ? (setCard(4), forceUpdate, renderContent(data.adventures, card)) : null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_media__WEBPACK_IMPORTED_MODULE_5__["default"], {
    queries: {
      medium: '(min-width: 748px) and (max-width: 987px)'
    }
  }, matches => matches.medium ? (setCard(3), forceUpdate, renderContent(data.adventures, card)) : null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_media__WEBPACK_IMPORTED_MODULE_5__["default"], {
    queries: {
      large: '(min-width: 988px) and (max-width: 1299px)'
    }
  }, matches => matches.large ? (console.log('beforelarge', card), setCard(4), console.log('afterlarge', card), renderContent(data.adventures, card)) : null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_media__WEBPACK_IMPORTED_MODULE_5__["default"], {
    queries: {
      xl: '(min-width: 1300px) and (max-width: 1529px)'
    }
  }, matches => matches.xl ? (setCard(5), forceUpdate, renderContent(data.adventures, card)) : null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_media__WEBPACK_IMPORTED_MODULE_5__["default"], {
    queries: {
      xl: '(min-width: 1530px)'
    }
...
//# sourceMappingURL=index.js.983a9055ccab2fa4a828.hot-update.js.map