...
var HostServicesHeader = function HostServicesHeader() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "flex items-center justify-start absolute z-50 top-0 left-0",
    __source: {
    ...
    className: "hidden lg:block px-4 md:px-0 flex bg-white w-full border-b border-gray-300 items-center justify-end lg:justify-between fixed border-t sticky top-0 z-50",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24
    },
    ...
    className: "w-auto flex items-center py-3 lg:py-0 justify-between",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48
    },
...
//# sourceMappingURL=services.js.148e8cd9e44f304dc94c.hot-update.js.map