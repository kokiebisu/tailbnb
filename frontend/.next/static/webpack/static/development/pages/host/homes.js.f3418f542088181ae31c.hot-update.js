...
var MoreHostingCard = function MoreHostingCard(_ref) {
  var img = _ref.img,
      ...
      last = _ref.last;
  return __jsx("div", {
    className: "w-1/3 md:border lg:border-none border-gray-300 md:shadow-xl lg:shadow-none",
    __source: {
    ...
    className: "w-full md:h-24 lg:h-48",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20
    },
...
//# sourceMappingURL=homes.js.f3418f542088181ae31c.hot-update.js.map