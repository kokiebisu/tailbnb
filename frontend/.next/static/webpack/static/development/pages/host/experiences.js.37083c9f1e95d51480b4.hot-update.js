...
var ExperienceBanner = function ExperienceBanner() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "relative w-screen h-screen bg-blue-500",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27
    },
    ...
    className: "w-full absolute bottom-0 bg-red-550 flex items-center justify-center h-48",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28
    },
    ...
    style: {
      fontFamily: 'aibnb-bold'
    },
    className: "text-white my-2 text-4xl",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30
    },
...
//# sourceMappingURL=experiences.js.37083c9f1e95d51480b4.hot-update.js.map