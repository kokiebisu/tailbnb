...
var Table = function Table(_ref) {
  ...
  return __jsx("div", {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("tr", {
      ...
      __self: this
    }, typeof row.column2 === 'boolean' ? renderBoolean(row.column3) : renderString(row.column3)))), __jsx("td", {
      className: "h-24 md:py-8 text-sm border-b border-gray-300 text-center",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 138
      ...
      __self: this
    }, typeof row.column3 === 'boolean' ? renderBoolean(row.column3) : renderString(row.column3))), __jsx("td", {
      className: "h-24 md:py-8 text-sm border-b border-gray-300 text-center",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 145
      ...
      __self: this
    }, typeof row.column4 === 'boolean' ? renderBoolean(row.column3) : renderString(row.column3))))));
  })))), __jsx("div", {
...
//# sourceMappingURL=financials.js.6cc52e807c6929b26178.hot-update.js.map