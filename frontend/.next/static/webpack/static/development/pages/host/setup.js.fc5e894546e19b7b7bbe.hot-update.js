...
var PeopleHost = function PeopleHost() {
  return __jsx("div", {
    className: "bg-red-300 w-full max-w-5xl mx-auto flex justify-center border-t border-b border-gray-300",
    __source: {
    ...
    className: "bg-red-100 pt-24 pb-12 flex flex-col items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
...
//# sourceMappingURL=setup.js.fc5e894546e19b7b7bbe.hot-update.js.map