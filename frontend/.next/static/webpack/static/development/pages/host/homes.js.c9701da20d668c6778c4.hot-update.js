...
var MoreHostingCard = function MoreHostingCard(_ref) {
  ...
  return __jsx("div", {
    ...
    className: "w-24 h-24 md:w-full md:h-32 lg:h-48",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20
    },
    ...
    className: "h-24 w-24 md:rounded-bottom-none lg:rounded object-cover",
    src: img,
    alt: "",
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=homes.js.c9701da20d668c6778c4.hot-update.js.map