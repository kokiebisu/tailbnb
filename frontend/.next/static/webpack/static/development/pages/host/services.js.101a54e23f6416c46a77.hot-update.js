...
var FindOutCard = function FindOutCard() {
  return __jsx("div", {
    className: "w-full px-6 md:px-0 md:max-w-2xl lg:max-w-5xl mx-auto pt-8 pb-16 rounded-lg shadow-lg border border-gray-300",
    __source: {
    ...
    className: "bg-red-200 mt-2 lg:mt-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62
    },
    ...
    className: "bg-red-550 text-white rounded px-12 py-3 w-full lg:auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 92
    },
...
//# sourceMappingURL=services.js.101a54e23f6416c46a77.hot-update.js.map