...
var MoreHostingCard = function MoreHostingCard(_ref) {
  ...
  return __jsx("div", {
    ...
    className: "w-full md:border lg:border-none md:rounded lg:rounded-none border-gray-300 md:shadow-xl lg:shadow-none",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19
    },
    ...
    className: "w-95p md:border lg:border-none md:rounded lg:rounded-none border-gray-300 md:shadow-xl lg:shadow-none",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49
    },
...
//# sourceMappingURL=homes.js.79e83e0297eeb0092fb8.hot-update.js.map