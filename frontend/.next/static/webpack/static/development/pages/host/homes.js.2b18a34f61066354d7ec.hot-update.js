...
var HostHomesHeader = function HostHomesHeader() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "lg:sticky bottom-0  flex items-center justify-start absolute z-50 top-0 left-0",
    __source: {
    ...
    className: "hidden lg:flex bg-white w-full border-b border-gray-300 items-center justify-between sticky top-0 z-50",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24
    },
...
//# sourceMappingURL=homes.js.2b18a34f61066354d7ec.hot-update.js.map