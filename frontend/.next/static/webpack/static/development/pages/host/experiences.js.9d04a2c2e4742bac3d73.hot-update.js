  ...
  switch (position) {
    case 'left':
      return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
        ...
        className: "flex flex-col justify-center items-end lg:items-center h-full",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 12
        },
...
var ExperienceAspect = function ExperienceAspect(_ref) {
  ...
  return __jsx("div", {
    className: "px-8 md:px-0 md:max-w-xl lg:max-w-5.5xl mx-auto flex items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 70
    },
...
//# sourceMappingURL=experiences.js.9d04a2c2e4742bac3d73.hot-update.js.map