...
var HostingSupport = function HostingSupport() {
  return __jsx("div", {
    className: "bg-red-200 w-full max-w-5xl mx-auto",
    __source: {
    ...
    className: "w-70p bg-red-400 text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 29
    },
    ...
    __self: this
  }, "As a host, the Airbnb community always has your back. For helpful tips and suggestions, you\u2019ll find a robust Help Centre, 375,000 hosts in our Community Centre, and a number of hosting tool kits."))))));
};

/***/ })

})
//# sourceMappingURL=setup.js.13357c7e6d98938882ca.hot-update.js.map