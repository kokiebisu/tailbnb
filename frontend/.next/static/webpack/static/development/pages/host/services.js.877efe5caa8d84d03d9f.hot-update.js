...
var HostServicesHeader = function HostServicesHeader() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "hidden lg:block flex items-center justify-start absolute z-50 top-0 left-0",
    __source: {
    ...
    className: "px-4 md:px-0 flex bg-white w-full border-b border-gray-300 items-center justify-end lg:justify-between fixed border-t sticky top-0 z-50",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24
    },
...
//# sourceMappingURL=services.js.877efe5caa8d84d03d9f.hot-update.js.map