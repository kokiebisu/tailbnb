...
var FindOutCard = function FindOutCard() {
  return __jsx("div", {
    ...
    className: "placeholder-black my-1 md:my-3 ml-3",
    ...
    className: "mb-2 md:w-2/3 lg:w-auto md:mr-2 lg:mr-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30
    },
    ...
    className: "appearance-none pl-2 w-full border border-gray-450 py-1 md:py-3 rounded placeholder-gray-900 tracking-wide text-gray-750",
    id: "guests",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32
    ...
    className: "md:w-1/3 lg:w-auto md:ml-2 lg:ml-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42
    },
...
//# sourceMappingURL=services.js.8ba9651f6e1f452f97ec.hot-update.js.map