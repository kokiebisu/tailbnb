...
var WorldwideCard = function WorldwideCard(_ref) {
  ...
  return __jsx("div", {
    ...
    className: "w-full md:w-1/3 flex flex-col md:items-center",
    __source: {
    ...
    className: "mtext-4xl md:text-gray-750 lg:text-6xl text-gray-850",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    },
    ...
    className: "md:text-sm lg:text-base text-gray-750 md:text-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19
    },
...
//# sourceMappingURL=homes.js.bcdff548fc2297206166.hot-update.js.map