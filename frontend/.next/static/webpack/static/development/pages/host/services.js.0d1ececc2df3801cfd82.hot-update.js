...
var FindOutCard = function FindOutCard() {
  return __jsx("div", {
    className: "w-full px-6 md:px-0 md:max-w-2xl lg:max-w-5xl mx-auto py-6 lg:pt-8 lg:pb-16 rounded-lg shadow-lg border border-gray-300",
    __source: {
    ...
    className: "bg-blue-200 lg:mb-8 flex justify-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
...
//# sourceMappingURL=services.js.0d1ececc2df3801cfd82.hot-update.js.map