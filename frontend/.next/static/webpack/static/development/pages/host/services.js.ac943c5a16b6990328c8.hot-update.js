...
var FindOutCard = function FindOutCard() {
  return __jsx("div", {
    className: "w-full px-2 md:px-8 md:px-0 md:max-w-1.5xl lg:max-w-5xl mx-auto py-4 lg:pt-8 lg:pb-16 rounded-lg md:shadow-lg md:border border-gray-300",
    __source: {
    ...
    className: "w-80p lg:w-full flex justify-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    },
...
//# sourceMappingURL=services.js.ac943c5a16b6990328c8.hot-update.js.map