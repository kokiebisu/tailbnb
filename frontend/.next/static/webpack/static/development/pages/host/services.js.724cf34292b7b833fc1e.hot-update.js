...
var HostServicesHeader = function HostServicesHeader() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "lg:hidden flex items-center justify-start mt-4 mb-16",
    __source: {
    ...
    className: "flex px-4 md:px-0 bg-white w-full border-b border-gray-300 items-center justify-end lg:justify-between fixed border-t sticky lg:top-0 bottom-0 z-50",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24
    },
    ...
    className: "w-full lg:w-auto flex items-center py-3 lg:py-0 justify-between",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48
    },
...
//# sourceMappingURL=services.js.724cf34292b7b833fc1e.hot-update.js.map