...
var PeopleHost = function PeopleHost() {
  return __jsx("div", {
    className: "w-full md:max-w-2xl lg:max-w-5xl mx-auto flex justify-center border-t border-b border-gray-300 mb-32",
    __source: {
    ...
    className: "text-2xl md:text-3xl text-gray-750 text-center leading-8",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    },
...
//# sourceMappingURL=setup.js.c225372da297faacf3ea.hot-update.js.map