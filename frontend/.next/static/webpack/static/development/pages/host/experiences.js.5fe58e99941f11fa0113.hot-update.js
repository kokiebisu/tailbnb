...
var ExperienceBanner = function ExperienceBanner() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "bg-red-550 mx-6 md:px-0 md:max-w-2xl lg:max-w-5.5xl",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "text-4xl md:text-7xl tracking-tighter leading-10 md:leading-20",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
    },
...
//# sourceMappingURL=experiences.js.5fe58e99941f11fa0113.hot-update.js.map