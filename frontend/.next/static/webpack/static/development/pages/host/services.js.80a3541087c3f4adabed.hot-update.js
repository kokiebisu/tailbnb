...
var ReadyConnect = function ReadyConnect() {
  return __jsx("div", {
    ...
    className: "md:w-1/2 lg:w-50p mb-4",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "text-white text-4xl md:text-6xl tracking-tighter leading-10 lg:leading-18",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    },
    ...
    className: "lg:mt-8 bg-white py-3 px-5 rounded",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21
    },
...
//# sourceMappingURL=services.js.80a3541087c3f4adabed.hot-update.js.map