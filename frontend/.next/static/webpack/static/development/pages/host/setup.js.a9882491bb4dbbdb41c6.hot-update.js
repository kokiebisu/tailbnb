...
var AdvertiseMillions = function AdvertiseMillions() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    className: "w-full px-6 md:px-0 md:max-w-3xl lg:max-w-5.5xl mx-auto pt-8 pb-16",
    __source: {
    ...
    className: "text-5xl lg:text-6xl tracking-tighter text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
    },
    ...
    className: "w-full md:max-w-2xl lg:max-w-5.5xl mx-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26
    },
    ...
    className: "w-full h-128 md:h-104 lg:h-112 px-6 md:px-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27
    },
    ...
    className: "my-10 w-full md:max-w-xl lg:max-w-5.5xl mx-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31
    },
    ...
    className: "flex flex-col lg:flex-row px-6 md:mx-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32
    },
...
//# sourceMappingURL=setup.js.a9882491bb4dbbdb41c6.hot-update.js.map