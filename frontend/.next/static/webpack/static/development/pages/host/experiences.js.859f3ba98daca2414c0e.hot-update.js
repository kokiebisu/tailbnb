...
var renderByPosition = function renderByPosition(positionl) {
  switch (position) {
    case 'left':
    ...
    case 'right':
      return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
        ...
        __self: this
      }, "Food tour by bike, light photography at night, tapas on a boat, or yoga (with goats). Create and curate a unique activity people want to try.")))))), __jsx("div", {
        className: "w-2/5",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 69
...
var ExperienceAspect = function ExperienceAspect(_ref) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, renderByPosition(position)));
};

/***/ })

})
//# sourceMappingURL=experiences.js.859f3ba98daca2414c0e.hot-update.js.map