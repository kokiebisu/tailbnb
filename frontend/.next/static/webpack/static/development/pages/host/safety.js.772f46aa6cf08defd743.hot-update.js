...
var GreatGuests = function GreatGuests() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "w-48 absolute bg-white shadow-xl w-40 border-r border-gray-300 z-50",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 58
    },
    ...
    className: "relative z-0 w-full table-fixed text-gray-750 my-8 top-0 overflow-x-scroll",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 96
    },
    ...
    id: "tableShadowTop",
    className: "w-16 md:w-1/5 border-b border-gray-300 text-center text-sm",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 106
    },
    ...
    className: "w-16md:w-1/5 border-b border-gray-300 text-center text-sm",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 114
    },
...
//# sourceMappingURL=safety.js.772f46aa6cf08defd743.hot-update.js.map