...
var ExperienceCategory = function ExperienceCategory() {
  return __jsx("div", {
    className: "relative w-screen bg-gray-100",
    __source: {
    ...
    className: "bg-blue-200 lg:max-w-5.5xl mx-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "grid grid-cols-3 gap-4 first:mr-3 mx-3 last:ml-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    },
...
//# sourceMappingURL=experiences.js.027eeb9460da3e8c2166.hot-update.js.map