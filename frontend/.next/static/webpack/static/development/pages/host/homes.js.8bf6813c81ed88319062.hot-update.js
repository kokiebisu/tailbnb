...
var HostHomesHeader = function HostHomesHeader() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "flex bg-white w-full border-b border-gray-300 items-center justify-end lg:justify-between fixed bottom-0 border-t border-gray-300 lg:border-none lg:sticky lg:top-0 z-50",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24
    },
    ...
    className: "flex items-center py-3 lg:py-0 justify-between",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62
    },
    ...
    className: "text-xl lg:text-2xl text-gray-750 lg:text-gray-850",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 82
    },
    ...
    className: "px-1 ml-2 mr-10 lg:mr-16",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 89
    },
...
//# sourceMappingURL=homes.js.8bf6813c81ed88319062.hot-update.js.map