...
var PeopleHost = function PeopleHost() {
  return __jsx("div", {
    className: "w-full px-6 md:max-w-2xl lg:max-w-5xl mx-auto flex justify-center border-t border-b border-gray-300 mb-32",
    __source: {
    ...
    className: "pt-24 pb-12 flex flex-col md:items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
...
//# sourceMappingURL=setup.js.ebac9be53b779aad8841.hot-update.js.map