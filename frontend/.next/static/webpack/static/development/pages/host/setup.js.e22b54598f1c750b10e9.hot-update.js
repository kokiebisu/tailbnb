...
var OnePhrase = function OnePhrase(_ref) {
  var title = _ref.title,
      link = _ref.link;
  return __jsx("div", {
    className: "w-full mx-6 md:px-0 md:max-w-2xl lg:max-w-5xl mx-auto flex justify-center border-t border-b border-gray-300 mb-32",
    __source: {
    ...
    className: "pt-12 pb-6 md:pt-20 md:pb-20 flex flex-col md:items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
...
//# sourceMappingURL=setup.js.e22b54598f1c750b10e9.hot-update.js.map