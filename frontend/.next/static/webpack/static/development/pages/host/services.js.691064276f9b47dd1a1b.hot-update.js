...
var HostServicesBanner = function HostServicesBanner() {
  return __jsx("div", {
    className: "w-full px-8 lg:px-0 lg:max-w-5xl xl:max-w-7xl mx-auto",
    __source: {
    ...
    className: "w-full lg:mt-16 lg:mb-10 md:flex justify-between",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
    ...
    className: "text-4xl lg:text-6xl leading-16 tracking-tighter",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
...
//# sourceMappingURL=services.js.691064276f9b47dd1a1b.hot-update.js.map