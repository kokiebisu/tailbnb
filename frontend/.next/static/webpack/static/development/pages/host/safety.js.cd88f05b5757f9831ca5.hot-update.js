...
var GreatGuests = function GreatGuests() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "w-full table-fixed text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 56
    },
    ...
    className: "w-1/6 border-b border-gray-300 text-center shadow-lg",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 66
    },
    ...
    className: "w-1/6 border-b border-gray-300 text-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 69
    },
    ...
    className: "py-8 text-sm border-b border-gray-300 text-center shadow-lg",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 80
    },
...
//# sourceMappingURL=safety.js.cd88f05b5757f9831ca5.hot-update.js.map