...
var MoreHostingCard = function MoreHostingCard(_ref) {
  ...
  return __jsx("div", {
    ...
    className: "w-full border lg:border-none rounded lg:rounded-none border-gray-300 shadow-md lg:shadow-none flex md:flex-none",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19
    },
    ...
    className: "h-full w-full rounded-l-none md:rounded-b-none lg:rounded object-cover",
    src: img,
    alt: "",
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=homes.js.1a985efc476e68798868.hot-update.js.map