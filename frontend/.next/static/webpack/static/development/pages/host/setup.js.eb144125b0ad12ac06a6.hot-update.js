...
var AdvertiseMillions = function AdvertiseMillions() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
    ...
    className: "text-4xl lg:text-6xl tracking-tighter text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
    },
    ...
    className: "w-full h-104 lg:h-112",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27
    },
    ...
    className: "my-10 w-full md:max-w-3xl lg:max-w-5.5xl mx-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31
    },
...
//# sourceMappingURL=setup.js.eb144125b0ad12ac06a6.hot-update.js.map