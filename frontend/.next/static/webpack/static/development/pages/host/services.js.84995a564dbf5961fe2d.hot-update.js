...
var FindOutCard = function FindOutCard() {
  return __jsx("div", {
    className: "w-full px-6 md:px-8 md:px-0 md:max-w-1.5xl lg:max-w-5xl mx-auto py-4 lg:pt-8 lg:pb-16 rounded-lg md:shadow-lg md:border border-gray-300",
    __source: {
    ...
    className: "mb-2 lg:mb-8 flex justify-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "md:w-80p lg:w-full flex justify-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    },
    ...
    className: "text-2xl lg:text-3.5xl text-gray-750",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "w-full mx-16 lg:mx-0 lg:flex lg:w-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17
    },
    ...
    className: "mb-2 w-2/3 lg:w-auto mr-2 lg:mr-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30
    },
    ...
    className: "w-1/3 lg:w-auto ml-2 lg:ml-0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42
    },
...
//# sourceMappingURL=services.js.84995a564dbf5961fe2d.hot-update.js.map