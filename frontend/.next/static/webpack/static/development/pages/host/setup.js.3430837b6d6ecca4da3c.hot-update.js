...
var HowToStart = function HowToStart() {
  return __jsx("div", {
    ...
    className: "w-full px-6 md:px-0 md:max-w-2.5xl lg:max-w-5.5xl mx-auto pt-8 pb-16",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
    ...
    className: "text-gray-750 md:text-4xl lg:text-6xl tracking-tighter",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21
    },
    ...
    className: "text-xl lg:text-2xl text-gray-750 leading-7 text-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28
    },
    ...
    className: "w-full max-w-2.5xl lg:max-w-5xl mx-auto relative",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48
    },
    ...
    className: "w-full h-96 lg:h-112",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 52
    },
...
//# sourceMappingURL=setup.js.3430837b6d6ecca4da3c.hot-update.js.map