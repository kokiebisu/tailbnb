...
var StayCard = function StayCard(_ref) {
  ...
  var renderhost = function renderhost(host_is_superhost) {
    if (host_is_superhost == 't') {
      return __jsx("div", {
        className: "bg-red-550 flex items-center justify-between mt-1",
        __source: {
        ...
        className: "uppercase border border-gray-800 rounded px-1 text-xs",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 27
        },
...
//# sourceMappingURL=index.js.6bc4e39f387493e8485b.hot-update.js.map