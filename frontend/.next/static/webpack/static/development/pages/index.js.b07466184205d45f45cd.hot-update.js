...
var Header = function Header(_ref) {
  ...
  return __jsx("header", {
    ...
    className: "w-screen md:h-screen md:min-h-80 relative bg-cover bg-no-repeat flex justify-center",
    __source: {
    ...
    className: "w-full bg-red-550 md:mx-20 xl:mx-20 xl:mx-20 xl:max-w-10xl mx-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 75
    },
...
//# sourceMappingURL=index.js.b07466184205d45f45cd.hot-update.js.map