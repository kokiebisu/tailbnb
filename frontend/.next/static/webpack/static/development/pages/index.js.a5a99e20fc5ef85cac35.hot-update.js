...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const renderContent = (data, number) => {
    ...
    for (let i = 0; i < number; i++) {
      content.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/4 xl:w-1/5 2xl:w-1/6 pb-5"
  ...
  }, matches => matches.small ? (setCard(4), renderContent(data.experiences, card)) : null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_media__WEBPACK_IMPORTED_MODULE_4__["default"], {
    queries: {
...
//# sourceMappingURL=index.js.a5a99e20fc5ef85cac35.hot-update.js.map