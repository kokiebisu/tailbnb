...
var CurrencyModal = function CurrencyModal(setCurrencyModal) {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, ' ', __jsx("div", {
    ...
    id: "centerAbsolute",
    className: "relative rounded-xl hidden fixed bg-white md:block w-240 pb-8 z-50",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    },
    ...
    className: "w-full mx-auto max-w-4.5xl border-b border-gray-300 mt-2 flex justify-center items-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    },
    ...
    className: "w-full mx-auto max-w-4.5xl",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37
    },
    ...
    className: "w-90p focus:border border-gray-750 rounded-lg hover:bg-gray-250 flex justify-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 65
    },
...
//# sourceMappingURL=index.js.bd46b50c3b25d7ba42b5.hot-update.js.map