...
var _this = undefined,
    _jsxFileName = "/Users/ken/Desktop/nextbnb/frontend/src/components/layout/Cookies.jsx";

var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;

var Cookies = function Cookies() {
  return __jsx("div", {
    className: "bg-white p-4 rounded-3xl shadow-4xl",
    __self: _this,
    __source: {
    ...
    className: "h-full bg-white border border-green-850 rounded-lg mr-1",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31,
    ...
    className: "px-12 py-3 whitespace-normal",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
    ...
    className: "text-xs text-green-850 ",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
...
//# sourceMappingURL=index.js.4d09bcaacde081b7db25.hot-update.js.map