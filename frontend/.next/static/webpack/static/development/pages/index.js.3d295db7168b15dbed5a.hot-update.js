...
var Notice = function Notice() {
  return __jsx("div", {
    className: "relative py-6 px-6 md:px-10 xl:px-32 xl:max-w-12xl",
    __source: {
    ...
    className: "border border-gray-300 md:mt-4 bg-white md:rounded-lg pt-7 pb-6",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
    ...
    className: "absolute left-0 bg-yellow-400 w-2 h-full",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    },
...
//# sourceMappingURL=index.js.3d295db7168b15dbed5a.hot-update.js.map