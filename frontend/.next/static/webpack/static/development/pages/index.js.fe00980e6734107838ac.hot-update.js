...
var HeaderCard = function HeaderCard() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "".concat(checkInDate[0], "/").concat(checkInDate[1], "/").concat(checkInDate[2])) : __jsx("button", {
    onClick: function onClick(e) {
      e.preventDefault();
      setCheckInModal(!checkInModal);
    },
    ...
    closeModal: function closeModal() {
      return setCheckInModal(!checkInModal);
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 88
...
//# sourceMappingURL=index.js.fe00980e6734107838ac.hot-update.js.map