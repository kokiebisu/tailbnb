...
const id = () => {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, {
    ...
    __self: undefined
  }, "Please note outdoor activities carry risks, and you may be exposed to dangerous situations as part of this experience. Make sure you can participate safely given your abilities and the conditions (such as location, weather, and equipment)."))))), __jsx(_components_layout_Footer__WEBPACK_IMPORTED_MODULE_15__["Footer"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 110
    },
