...
const ImagePanel = ({
  ...
  setSleep(2000);
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, type === 'stay' ? __jsx("div", {
    id: "zoomwrapper",
    ...
    className: "w-full h-75v max-h-57v flex justify-start bg-blue-500",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 101
    },
...
const id = () => {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, {
    ...
    __self: undefined
  }, data.stay.size, " hosted by ", data.stay.host_name), loading ? null : data && __jsx("div", {
    style: {
      fontFamily: 'airbnb-book'
    },
    ...
    __self: undefined
  }, loading ? null : data && __jsx(_components_containers_Characteristics__WEBPACK_IMPORTED_MODULE_15__["Characteristics"], {
    ...
    __self: undefined
  })), loading ? null : data && __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx("div", {
